    ...
    public static class IsothermCalculator
    {
        ...
        public static void UpdateFromQe(IsothermPoint point, IsothermSeries series, double qe)
        {
            ...
            if (point.InitialOpticalDensity <= 0 || point.SorbentMassG <= 0
                || series.calibrationK <= 0 || series.solutionVolumeMl <= 0
            ...
            double initialMassConcentration = point.InitialOpticalDensity / series.calibrationK;
            ...
            equilibriumMassConcentration = Math.Max(0.0000001, equilibriumMassConcentration);
